...
Code mentions are a way to link code and the text. We borrow the link syntax from markdown to create hoverable links to the code. It's easier to show than to explain:
...
```mdx your.mdx focus=1,18,19,21 mark=18[20:34],19[20:33]
