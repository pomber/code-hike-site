...
Here we use the @next/mdx plugin to set up MDX imports. 
...
To set up Code Hike you need to [import the @code-hike/mdx plugin](focus://1,6[1:6]), and add it to the remarkPlugins array in the next.config.js file. 
